  ...
  //           });
    ...
    public function bookRoom(Requests $request)
    {
        ...
        [
            ...
            "start_date.required" => __('message.end_date'),
            "adult.required" => __('message.end_date'),
            "children.required" => __('message.end_date'),
            // "address.required" =>  __('message.address'),
            // "content.required" =>  __('message.content'),
        ]);
        ...
        return back()->with(['message' => __('message.post_req_success')]);
        // $data->name = $request->name;
        // $data->phone = $request->phone;
        // $data->address = $request->adress;
        // $data->email = $request->email;
